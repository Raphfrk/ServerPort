...
public class MiscUtils {
	...
	static int getSafeExit( IntLocation startExit , TreeMap<String,Boolean> softBlocks ) {
		...
		while( temp.y > 2 && softBlocks.containsKey( ((Integer)server.getBlockIdAt(startExit.getWorld(), temp.x, temp.y-1, temp.z)).toString() ))  {
		...
		while
			( temp.y < 125 && 
					( 
							!softBlocks.containsKey( ((Integer)server.getBlockIdAt(startExit.getWorld(),temp.x, temp.y, temp.z)).toString() ) ||
							!softBlocks.containsKey( ((Integer)server.getBlockIdAt(startExit.getWorld(),temp.x, temp.y+1, temp.z)).toString() ) 
